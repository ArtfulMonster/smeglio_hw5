...
if dataset == 'mini-speech':
  data_dir = pathlib.Path(os.path.join(os.getenv("USERPROFILE"), 'data/mini_speech_commands'))
  ...
  data_dir = pathlib.Path(os.path.join(os.getenv("USERPROFILE"), 'data', 'speech_commands_files_0.2'))
else:
